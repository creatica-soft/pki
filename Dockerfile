...
RUN git clone https://github.com/creatica-soft/pki && \
    ...
    sudo cp -r acme certificates certbot cmp cmp_client crls est est_client lib mswstep msxcep ocsp domains.txt *.html *.php *.ico /var/www/pki.example.com/ && \
    sudo chown -R alpine:nobody /var/www/pki.example.com && \
    sudo chmod 755 /var/www/pki.example.com/certbot/*.sh && \
